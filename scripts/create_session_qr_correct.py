...
async def main():
    ...
    try:
        ...
        token_base64 = base64.urlsafe_b64encode(r.token).decode('ascii').rstrip('=')
        
        # Create login URL with https://t.me/login format
        login_url = f"https://t.me/login?token={token_base64}"
        ...
        print(f"Token (base64url): {token_base64}")
