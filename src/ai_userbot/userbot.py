    ...
    async def start(self):
        ...
        if await self.client.is_user_authorized():
            ...
            try:
                ...
                print("="*80)
                print("Для авторизации используйте Telegram Desktop или мобильное приложение:")
                print("1. Откройте Telegram → Настройки → Устройства → Подключить устройство")
                print("2. Введите код авторизации или отсканируйте QR-код")
                print("3. Дождитесь завершения авторизации")
                print("="*80)
                ...
                try:
                    ...
                    print("Используйте URL выше для ручной авторизации")

                print("⏰ ОЖИДАНИЕ АВТОРИЗАЦИИ... (до 2 минут) ⏰")
                print("="*80 + "\n")
